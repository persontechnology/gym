                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('generarMiDietas') }}" id="formCliente">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cedula" type="number" class="form-control{{ $errors->has('cedula') ? ' is-invalid' : '' }}" name="cedula" value="{{ $cliente->cedula ?? '' }}" placeholder="Ingrese cédula" required autofocus>
