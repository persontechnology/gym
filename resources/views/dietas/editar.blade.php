        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                       <form method="POST" action="{{ route('actualizarDieta') }}" enctype="multipart/form-data" id="formCliente">
                            @csrf

                            <input type="hidden" name="id" id="id" value="{{$dieta->id}}">
                            <!-- nombres -->
                            <div class="form-group row">
                                <label for="titulo" class="col-md-4 col-form-label text-md-right">Titulo</label>

                                <div class="col-md-6">
                                    <input id="titulo" type="text" class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" name="titulo" value="{{ $dieta->titulo}}" required >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="peso" type="number" class="form-control{{ $errors->has('peso') ? ' is-invalid' : '' }}" name="peso" value="{{ $dieta->peso }}" required >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="altura" type="text" class="form-control{{ $errors->has('altura') ? ' is-invalid' : '' }}" name="altura" value="{{ $dieta->altura }}" required >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <textarea id="detalle" type="text" class="form-control{{ $errors->has('detalle') ? ' is-invalid' : '' }}" name="detalle">{{ $dieta->detalle }}</textarea>
